...
class TestCadastro(unittest.TestCase):
    def test_cadastro(self):
        ...
        self.assertEqual(self.bt.interacao_chat(id2, e1)['RESPOSTA'], s1)
        self.assertEqual(self.bt.interacao_chat(id1, e2)['RESPOSTA'], s2)
        self.assertEqual(self.bt.interacao_chat(id1, e3)['RESPOSTA'], s3)
        self.assertEqual(self.bt.interacao_chat(id2, e2_)['RESPOSTA'], s2)
        self.assertEqual(self.bt.interacao_chat(id2, e3_)['RESPOSTA'], s3)
        ...
        self.assertEqual(self.bt.interacao_chat(id2, e4_)['RESPOSTA'], s4)
        self.assertEqual(self.bt.interacao_chat(id2, e5_)['RESPOSTA'], s5)
        self.assertEqual(self.bt.interacao_chat(id2, e6_)['RESPOSTA'], s6)
        self.assertEqual(self.bt.interacao_chat(id1, e7)['RESPOSTA'], s7)
        self.assertEqual(self.bt.interacao_chat(id1, e8)['RESPOSTA'], s8)
        self.assertEqual(self.bt.interacao_chat(id2, e7_)['RESPOSTA'], s7)
        self.assertEqual(self.bt.interacao_chat(id2, e8_)['RESPOSTA'], s8_)
        self.assertEqual(self.bt.interacao_chat(id2, e9)['RESPOSTA'], s9)
